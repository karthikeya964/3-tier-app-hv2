...
resource "aws_s3_bucket" "artifact" {
  bucket = "capstone-cft-pipeline-artifacts-${random_id.rand.hex}"
}
...
resource "aws_iam_role" "eks_cluster_role" {
  ...
  tags = { Name = "Capstone-cluster-role" }
}
...
resource "aws_iam_role" "eks_node_role" {
  ...
  tags = { Name = "Capstone-eks-node-role" }
}
...
resource "aws_security_group" "rds_sg" {
  ...
  tags = { Name = "Capstone-rds-mysql-sg" }
}
...
resource "aws_db_instance" "mysql" {
  ...
  tags = { Name = "Capstone-rds-instance" }
}
